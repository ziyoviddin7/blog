                                    ...
                                    <tr class="bg-white hover:bg-gray-50">
                                        <td class="size-px whitespace-nowrap">
                                            <a class="block relative z-10" href="{{ route('task.show', $task->id) }}">
                                                <div class="px-6 py-2">
                                                    <div class="block text-sm text-blue-600 decoration-2 hover:underline">
                                                        {{ $task->title }}</div>
                                                </div>
                                            </a>
                                        </td>
                                        ...
                                        <td class="size-px whitespace-nowrap">
                                            <a class="block relative z-10" href="{{ route('task.show', $task->id) }}">
                                                <div class="px-6 py-2 flex gap-x-1">
                                                    <p style="font-size: 15px">{{ $task->created_at->format('d F H:i') }}
                                                    </p>
                                                </div>
                                            </a>
                                        </td>
                        ...
                        <div
                            ...
                            <div>
                                <p class="text-sm text-gray-600">
                                    <span class="font-semibold text-gray-800">{{ $tasks->count() }}</span> results
                                </p>
