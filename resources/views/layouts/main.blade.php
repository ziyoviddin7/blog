        ...
        <nav class="px-4 sm:px-6 flex basis-full items-center w-full mx-auto">
            <div class="me-5 lg:me-0 lg:hidden">
                ...
                <a class="flex-none rounded-md text-xl inline-block font-semibold focus:outline-none focus:opacity-80"
                    href="{{ route('task.index') }}" aria-label="Preline">
                        ...
                        <li class="hs-accordion" id="projects-accordion">
                            ...
                            <div id="projects-accordion-child"
                                ...
                                <ul class="ps-8 pt-1 space-y-1">
                                        <li>
                                            <a href="{{ route('task.create') }}" class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-800 rounded-lg hover:bg-gray-100 focus:outline-none focus:bg-gray-100"
                                                >
                                                Task
                                            </a>
                                        </li>
    ...
    <script>
        document.getElementById('createDropdown').addEventListener('change', function() {
            ...
            if (selectedValue === 'task') {
                window.location.href = "{{ route('task.create') }}"; // Переход на страницу создания задачи
            } else if (selectedValue === 'category') {
                window.location.href = 'category-create.html'; // Переход на страницу создания категории
            }
        });
    </script>
