...
<body>
    ...
    <section class="bg-white dark:bg-gray-900">
        ...
        <div class="container flex items-center justify-center min-h-screen px-6 mx-auto">
            ...
            <form action="{{ route('user.login') }}" method="post" class="w-full max-w-md">
                @csrf
                ...
                <div class="mt-6">
                    ...
                    <div class="mt-6 text-center ">
                        <a href="{{ route('user.register') }}" class="text-sm text-blue-500 hover:underline dark:text-blue-400">
                            Register
                        </a>
                    </div>
                </div>
